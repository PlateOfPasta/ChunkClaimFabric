...
/** Enumerates sapling growth type. */
public enum GrowthType {
  /** Growth type occurred due chunk world generation. */
  WORLD_GEN,
  /** Growth occurred due to natural sapling growth. */
  NATURAL_GROWTH,
  /** Growth occurred due to a player using bonemeal. */
  PLAYER_GROWTH
}
